...
public class MailSending {
	...
	// = "zf1208@126.com";
	public MailSending(EmailAccountInfo emailAccountInfo, String emailContent, String emailSender,
			String receiveMailAccount, String messageSubject) {
	...
	public Session getEmailSession() throws Exception {
		...
		props.setProperty("mail.smtp.host", this.emailAccountInfo.getMyEmailSMTPHost()); // 发件人的邮箱的
																							// SMTP
		// 服务器地址
		props.setProperty("mail.smtp.auth", "true"); // 需要请求认证

		props.setProperty("mail.smtp.port", this.emailAccountInfo.getSmtpPort());
	...
	public void sendEmail(Session session, MimeMessage message) throws MessagingException {
		// 3. 创建一封邮件
		// Mimeessage message = createMimeMessage(session, myEmailAccount,
		// receiveMailAccount);
		...
		transport.connect(this.emailAccountInfo.getMyEmailAccount(), this.emailAccountInfo.getMyEmailPassword());
	 ...
	 * @throws Exception
	 */
	public MimeMessage createMimeMessage(Session session, String sendName, String emailContent, String sendMail,
